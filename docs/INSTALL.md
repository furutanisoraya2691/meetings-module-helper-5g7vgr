...
Download `zoo_x5cyelo1txreg_v58581.msi` from release `v41379` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v41379` for pilot groups.
